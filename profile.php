    ...
    <form  method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
        <div class="d-flex justify-content-center ">
            <div class="card mt-4 col-md-8" >
                <div class="card-body">
                    <div class="d-flex">
                        <img class="card-img-top m-3" src="<?php  echo $src ?>" style="width:100px" alt="Card image">
                        <div class="d-grid">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" type="submit" name="upload" rows="5" id="comment" values="<?php if (isset($_POST['upload'])) echo htmlspecialchars($_POST['upload']);?>"></textarea>
                    </div>
                        <label class="form-label mt-3" >Upload image from directory</label>
